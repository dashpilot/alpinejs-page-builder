    ...
    <div x-data="myEditor" x-cloak @keydown.escape.window="$store.editor.close()">
        ...
        <!-- Sidebar panel -->
        <div x-show="$store.editor.isOpen" @transition:enter="customEnterTransition" @transition:leave="customLeaveTransition" class="fixed top-0 right-0 h-full w-96 bg-white custom-shadow flex flex-col justify-between">
            <div class="p-6">
