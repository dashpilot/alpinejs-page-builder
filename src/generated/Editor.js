            ...
            <div class="p-6">
                ...
                <template x-if="$store.editor.curIndex !== false">
                    <div class="space-y-4" spellcheck="false">
                        ...
                        <template x-if="$store.editor.curFields.includes('subtext')">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1"> Subtext </label>
                                <textarea :class="formInput" rows="4" placeholder="Enter description" x-model="$store.app.data.posts[$store.editor.curIndex].subtext"></textarea>
                            </div>
                        </template>
